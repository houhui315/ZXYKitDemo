...
//  ZXYKitDemo
//
//  Created by 蓝泰致铭        on 16/7/14.
//  Copyright © 2016年 houhui. All rights reserved.
//

#import "ZXYBaseModel.h"
#import <objc/runtime.h>

@implementation ZXYBaseModel
...
- (void)parserDictionary:(NSDictionary*)dictionary {
    ...
    for (NSString * parmeValue in keys) {
        ...
        if ([self respondsToSelector:selector]) {
            //执行set方法
            NSObject *dicValue = [dictionary objectForKey:parmeValue];
